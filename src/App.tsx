...
export default function App(){
 ...
 return <div className="simple-app">
  ...
  <section className={'voice-control '+voiceState} aria-label="Voice companion">
   ...
   <b className="voice-state-label">{label}</b>{voiceError&&<p className="simple-voice-error" role="alert">{voiceError}</p>}<small className="voice-engine">GPT-Live-1 · automatic annotation</small>
  </section>
